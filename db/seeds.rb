...
Answer.create!([
  ...
  {body: 'yes', question_id: questions.[15].id, correct: false},
  {body: 'no', question_id: questions.[15].id, correct: true},
  {body: 'dont know', question_id: questions.[15].id, correct: false},
  {body: 'sure', question_id: questions.[15].id, correct: false},
])
